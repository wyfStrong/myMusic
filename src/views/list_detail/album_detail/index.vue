      ...
      <div id="all">
        ...
        <div id="img">
          <div class="left">
            <div class="imgBox">
              <img
                v-lazy="listsource.album_pic ? listsource.album_pic : ''"
                alt=""
              />
              <p>
                <span>{{ listsource.publish }}</span>
              </p>
            </div>
          </div>
          <div class="right">
            <h3>{{ listsource.album_name }}</h3>
            <div class="nickname">
              <div class="small">
                <img
                  v-lazy="listsource.artist_pic ? listsource.artist_pic : ''"
                  alt=""
                />
              </div>
              <p>{{ listsource.artist_name }}</p>
            </div>
          </div>
        </div>
...
export default {
  ...
  mounted() {
    ...
    this.$eventBus.$on("getRadioList", (arg) => {
      this.listsource = arg;
    });
